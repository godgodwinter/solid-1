...
const PaketsoalData = () => {
  const query = createQuery(() => ["repoDataPaket"], fn_fetchData);
  ...
  return (
    <Switch>
      ...
      <Match when={query.isSuccess}>
        {/* <div>
          aaaa <h1>{query.data.data[0].aspek_detail_nama}</h1>
        </div> */}
        {/* !jika query.data.data.length >0 maka tampilkan card */}
        {/* <PaketCard1 /> */}
        {/* ! jika 0 tampilkan pesan error Paket tidak tersedua */}
        {/* <FailedComponent message={query.error.message} /> */}
        ...
        <ul class="my-4 space-y-3">
          <li>
            <span class="flex items-center p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-400  group hover:shadow ">
              ...
              <span class="flex-1 ml-3 whitespace-nowrap">1. MetaMask</span>
          ...
          <li>
            ...
            >
              ...
              <span class="flex-1 ml-3 whitespace-nowrap">3. Opera Wallet</span>
          ...
          <li>
            ...
            >
              ...
              <span class="flex-1 ml-3 whitespace-nowrap">5. Fortmatic</span>
            </a>
          </li>
        </ul>
        {/* <div>
